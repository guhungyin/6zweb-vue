    ...
    <ul class="d-flex justify-content-between align-items-end pb-2 px-0 m-0 h-100">
      <li :class="{ active: $route.path === '/' }">
        ...
        >
          ...
          <span class="bottomMenuName mt-1">Início</span>
        </RouterLink>
      </li>
      <li :class="{ active: $route.path === '/deposit' }">
        ...
        >
          ...
          <span class="bottomMenuName mt-1">Depósito</span>
        </RouterLink>
      </li>
      <li class="main">
        <RouterLink
        ...
        >
          ...
          />
          <span class="bottomMenuName mt-1">Afiliado</span>
        </RouterLink>
      </li>
      <li>
        <button
          class="btn d-flex flex-column justify-content-center align-items-center text-decoration-none p-0"
          type="button"
        ...
        >
          ...
          <span class="bottomMenuName mt-1">Perfil</span>
        </button>
      </li>
      <li>
        <a
        ...
        >
          ...
          <span class="bottomMenuName mt-1">Menu</span>
        </a>
      </li>
    </ul>
  </section>
