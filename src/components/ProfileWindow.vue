...
<template>
  <div
    class="offcanvas profileWindow offcanvas-top"
    tabindex="-1"
    id="profileWindow"
    aria-labelledby="profileWindowLabel"
  >
      ...
      <div class="main">
        <div class="userInfo">
          <div class="userContent d-flex justify-content-between align-items-center mb-3">
            <router-link
              to="/changePassword"
              class="userImg d-flex justify-content-between align-items-center"
            >
        ...
        <ul class="p-3 d-flex flex-wrap">
          ...
          <li class="py-2">
            <svg
              ...
              height="16"
              fill="#8ea7bb"
              class="bi bi-chat-dots-fill icon"
              viewBox="0 0 16 16"
            >
              <path
