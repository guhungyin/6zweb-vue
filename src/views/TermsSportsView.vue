...
<template>
  <div class="routerView">
    ...
    <div class="termsSportsWindows container-fluid mt-2">
      ...
      <p>
        <span
          >1.1. This set of terms and conditions govern the use of the Sportsbook platform. When
          placing a bet with the Sportsbook platform, the Account Holder is therefore agreeing that
          the Account Holder has read, understood and will be adhering to these Terms and Conditions
          including the general Terms and Conditions at any time applicable to Sportsbook platform,
          click .</span
        >
      </p>
      <p>
        <span
          >1.2. The use of this Sportsbook platform is subject to the regulations imposed by the
          (Curaçao license).</span
        >
      </p>
      <p>
        <span
      ...
      <p>
        <span
          >1.4. Sportsbook platform reserves the right to make changes to the site, betting limits,
          payout limits and offerings.</span
        >
      </p>
      <p>
        <span
      ...
      <p>
        <span
          ...
          also applies to plural. References to gender are non-binding and to be treated for
      ...
      <p>
        <span
          >2.1. Sportsbook platform – legal entity engaged in betting activities in accordance with
          the licensing and legislative requirements of the country.</span
        >
      </p>
      <p>
        <span
      ...
      <p>
        <span
          >2.4. Stake - the amount of money transferred by the client to the Sportsbook platform and
          which are the main conditions for participation in a bet in accordance with these
          Rules.</span
        >
      </p>
      <p>
      ...
      <p>
        <span
          >2.6. Odd — the number by which the bet amount of the stakeholder is multiplied when
          determining the payout amount if bet wins.
        </span>
      </p>
      <p>
        <span
          >2.7. Winnings - cash to be paid to the Client upon the outcome, on which a bet was
          made.</span
        >
      </p>
      <p>
      ...
      <p>
        <span
          >2.8.2. Free money - client gets a bet amount and the winning on his account. For example,
          freebet 5 on odd 3.5 client get &nbsp;5*3.5 = 18.50</span
        >
      </p>
      <p>
        <span
          >2.8.3. Bet without risk - player uses his money for bet, but if bet is lost he gets his
          money back.
        </span>
      </p>
      <h2>
      ...
      <p>
        <span
          >3.2. All bets accepted by Sportsbook platform are subject to these rules, as well as to
          applicable licence conditions.</span
        >
      </p>
      <p>
        <span
          >3.3. Sportsbook platform reserves the right to refuse, restrict, cancel or limit any
          bet.</span
        >
      </p>
      <p>
        <span
          >3.4. Sportsbook platform reserves the right to settle after the contest is final or with
          official results</span
        >
      </p>
      <p>
        <span
      ...
      <p>
        <span
          >3.8. Maximum bet amounts on all sporting events will be determined by Sportsbook platform
          and are subject to change without prior written notice. Sportsbook platform also reserves
          the right to adjust limits on individual accounts as well.</span
        >
      </p>
      <p>
        <span
      ...
      <p>
        <span
          >3.13. Sportsbook platform reserves the right to suspend a client account without prior
          notice.</span
        >
      </p>
      <p>
        <span
          >3.14. In the event of there being a discrepancy between the English language version of
          these rules and any other language version, the English language version will be deemed to
          be correct.</span
        >
      </p>
      <p>
      ...
      <p>
        <span
          >3.16. Any bets placed with a system bet will not count for the wagering requirement in
          Bonus.</span
        >
      </p>
      <p>
      ...
      <p>
        <span
          >3.19. Sportsbook platform reserves the right to void or cancel any bets where the outcome
          has been altered by the imposition of penalty points, enforced relegations or any other
          measure enforced as a result of anything other than the normal results of the
          games/competitions in question.</span
        >
      </p>
      <p>
        <span
      ...
      <p>
        <span
          >3.24. Sportsbook platform don't responsible for the damage incurred by the client as a
          result of a system malfunction, defects, delays, manipulations or errors in data
          transfer.</span
        >
      </p>
      <p>
        <span
          >3.25. Clients' claims are considered by Sportsbook platform within thirty days from the
          moment the Client submits a written application to Sportsbook platform. After making a
          decision, Sportsbook platform notifies the client by means of an email linked to the game
          account.</span
        >
      </p>
      <p>
        <span
          >3.26 In case of suspicion of unfair activity, Sportsbook platform reserves the right to
          void any bet or any part of it, thus making the questionable bet invalid (in these cases,
          the payout is made with odds of “1”) or suspend any withdrawals for up to 31 calendar
          days.</span
        >
      </p>
      <p>
      ...
      <p>
        <span
          >3.29. Statistics or editorial text published at the Sportsbook platform site are to be
          considered as added information but Sportsbook platform does not acknowledge or accept any
          liability whatsoever if the information is not correct. At all times it is the Account
          Holder’s responsibility to be aware about circumstances relating to an event.</span
        >
      </p>
      <p>
        <span
          >3.30. It is forbidden to use the automatic system (any kind of scanners or robots) on
          Sportsbook. Sportsbook platform reserves the right to cancel any bet which made using
          automatic systems</span
        >
      </p>
      <p>
        <span
      ...
      <p>
        <span
          >4.2. Combo - bet on several independent outcomes of events. To win on express it is
          necessary that none of the outcomes that are included in the express, there was no loss.
          Losing one of the results of the combo means losing all over the combo. Combo payment is
          equal to the product the amount of the bet on the odds of all outcomes included in the
          combo.</span
        >
      </p>
      <p>
      ...
      <p>
        <span
          >4.4. A ‘Trixie’ is a combination, which includes one treble and three doubles from a
          selection of three matches.</span
        >
      </p>
      <p>
        <span
          >4.5. A ‘Patent’ is a combination, which includes one treble, three doubles and three
          singles from a selection of three matches.</span
        >
      </p>
      <p>
        <span
      ...
      <p>
        <span
          >4.7. A ‘Canadian’ (also known as ‘Super Yankee’) is a combination, which includes one
          fivefold, five fourfolds, ten trebles and ten doubles from a selection of five
          matches.</span
        >
      </p>
      <p>
        <span
          >4.8. A ‘Heinz’ is a combination, which includes one sixfold, six five folds, fifteen
          fourfolds, twenty trebles and fifteen doubles from a selection of six matches.</span
        >
      </p>
      <p>
        <span
      ...
      <p>
        <span
          ...
          twenty-eight sixfolds, fifty-six fivefolds, seventy fourfolds, fifty-six trebles and
          twenty-eight doubles from a selection of eight matches.</span
        >
      </p>
      <p>
        <span
          >4.11. If odds consider more than 2 digits after the decimal point, the payout will be
          rounded for the second digit after the decimal point.
        </span>
      </p>
      <p>
        <span
      ...
      <p>
        <span
          >5.2. "Correct Score" ( is where it is possible to bet on the (partial or definite) exact
          score of a match or event.</span
        >
      </p>
      <p>
        <span
      ...
      <p>
        <span
          >5.4. "Odd/Even" is where it is possible to bet on the (partial or definite) amount of a
          predefined occurrence (e.g. goals, points, corners, rebounds, penalty minutes, etc.)."Odd"
          is 1,3,5 etc.; "Even" is 0,2,4 etc.</span
        >
      </p>
      <p>
        <span
          >5.5. A "Head-to-Head'' and/or "Triple-Head" is a competition between two or three
          participants/outcomes, originating from either an officially organised event, or else, as
          virtually defined by the Sportsbook platform.</span
        >
      </p>
      <p>
        <span
      ...
      <p>
        <span
          >5.13. Bets on "Result at end of Quarter / Half / Period X '' refer to the result of the
          match/event after termination of the stipulated time frame and will take into account all
          other points/goals/events tallied from previous parts of the event/match.</span
        >
      </p>
      <p>
        <span
      ...
      <p>
        <span
          >5.18. Any reference to "clean sheet" indicates that the listed team must not concede any
          goal during the match.</span
        >
      </p>
      <p>
        <span
          >5.19. "Team to win from behind" refers to the listed team winning the match after having
          been at least 1 goal down at any point in the match.</span
        >
      </p>
      <p>
        <span
      ...
      <p>
        <span
          >5.21. Any reference to "Injury Time" refers to the amount displayed by the designated
          official and not to the actual amount played.</span
        >
      </p>
      <p>
        <span
      ...
      <p>
        <span
          >6.1.4. All players who took part in the match since kick off are considered as
          runners.</span
        >
      </p>
      <p>
        ...
        <span
          >&nbsp;markets, if a player is not in the starting XI all player markets will be
          voided.</span
        >
      </p>
      <p>
        ...
        <span
          >&nbsp;markets - bets will stand, if a player came into the game from substitute. Non
          fielders and players who were listed in the squad but remained on the substitute bench and
          did not play in the game will be voided. (Non fielders - player who were not listed in the
          match day squad)</span
        >
      </p>
      <p>
        <span>6.1.7. </span>
      ...
      <p>
        ...
        <span
          >&nbsp;markets - bets will stand, if a player came into the game from substitute. Non
          fielders and players who were listed in the squad but remained on the substitute bench and
          did not play in the game will be voided. If a player came out of the game before the last
          goal was scored, bets will be voided. (Non fielders - player who were not listed in the
          match day squad)</span
        >
      </p>
      <p>
        <span
          >6.1.9. If for any reason an unlisted player scores a goal all bets on listed players
          stand.</span
        >
      </p>
      <p>
        <span
          >6.1.10. Anytime Goalscorer or Player to score X or Next Goalscorer market will be settled
          based on TV insert and statistics provided by Press Association unless there is clear
          evidence that these statistics are not correct</span
        >
      </p>
      <p>
        <span
      ...
      <p>
        <span
          >6.1.14. Booking interval markets are settled based on the time the card is shown and not
          the time the infringement is made</span
        >
      </p>
      <p>
        <span
          >6.1.15. Offsides will be settled based on the time when the referee gives the decision.
          This rule will be applied to any video assistant referee (VAR) situation.</span
        >
      </p>
      <p>
        <span
          >6.1.16. Penalty markets will be settled based on the time when the referee gives the
          decision. This rule will be applied to any video assistant referee (VAR) situation.</span
        >
      </p>
      <p>
      ...
      <p>
        <span
          >6.1.23. Yellow card counts as 1 card and red or yellow-red card as 2. The 2nd yellow for
          one player which leads to a yellow red card is not considered. As a consequence one player
          cannot cause more than 3 cards.</span
        >
      </p>
      <p>
        <span
          >6.1.24. Settlement will be made according to all available evidence of cards shown during
      ...
      <p>
        <span
          >6.1.27. Yellow cards count as 10 points and red or yellow red cards as 25. The 2nd yellow
          for one player which leads to a yellow red card is not considered. As a consequence one
          player cannot cause more than 35 booking points.</span
        >
      </p>
      <p>
        <span
      ...
      <p>
        <span
          >6.1.29. If the match format was changed, the sportsbook reserves the right to void all
          bets.
        </span>
      </p>
      <p>
        <span
          >6.1.30. If a friendly match ended by referee decision earlier than 80 minutes, the bets
          will be canceled.</span
        >
      </p>
      <p>
        <span
          >6.1.31. All soccer player props bets are settled using the information provided by OPTA (
          <a
            href="https://www.google.com/url?q=https://soccerstats.info/&amp;sa=D&amp;source=editors&amp;ust=1692270306507594&amp;usg=AOvVaw2OSTmy3TdqkygU6UA-TYVU"
            class="c20"
            >https://soccerstats.info/</a
          >)
        </span>
      </p>
      <p>
      ...
      <p>
        ...
        <span
          >&nbsp;("Video Review") during matches is confirmed by TV broadcasts after the following
          events: the head referee gives the sign for a video review (a box drawn in the air), the
          head referee checks the incident on the on-pitch video review screen.</span
        >
      </p>
      <p>
        <span>Note.</span>
        ...
        <span>
          <a
            href="https://www.google.com/url?q=https://football-technology.fifa.com/en/innovations/var-at-the-world-cup-russian&amp;sa=D&amp;source=editors&amp;ust=1692270306508397&amp;usg=AOvVaw2TvvnBYM3JT-UuoqoqGazg"
            class="c20"
            >More on the official video review system (VAR)</a
          ></span
        >
        <span>. </span>
      </p>
      ...
      <p>
        <span
          >Different governing bodies have different rules, and where possible Opta works with the
          relevant people to reflect their official decisions on goal scorers.</span
        >
      </p>
      <p>
        <span
