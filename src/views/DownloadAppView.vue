...
<template>
  ...
  <div class="container-fluid mt-3 downloadApp">
    <div class="downloadContent mb-3">
      ...
      entretenimento. Não há nenhuma conexão necessária entre os resultados no jogo social e os
      resultados na vida real. Você pode se divertir jogando de graça, com compras opcionais
      incluídas no jogo. Faça o download do jogo e comece agora!
    </div>
  ...
  <img src="../assets/images/download/downloadBtn.png" class="w-100 mb-5" alt="" />
</template>
<style scoped>
.app {
  padding-top: 4rem;
