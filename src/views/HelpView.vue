...
<template>
  ...
  <div class="container-fluid mt-3 helpWindows pb-5">
    <div class="">
      ...
      <ul>
        ...
        <li class="mb-2">
          Insira seu número e senha de seis ou mais caracteres e selecione "Criar Usuário" para
          receber um PIN por sms.
        </li>
        <li class="mb-2">Insira o PIN e sua conta será ativada.</li>
      </ul>
      <p>
    ...
    <div class="">
      ...
      <ul>
        ...
        <li class="mb-2">Insira sua aposta desejada.</li>
        <li class="mb-2">
          Clique em
          <b>“Fazer aposta”</b>
        </li>
    ...
    <hr />
    <div class="">
      <h2>Como Verificar Minhas Apostas e Conta Declaração</h2>
      <ul>
        <li class="mb-2">
          Abra seu navegador e digite:
          <span class="link">6z.com</span>
        ...
        <li class="mb-2">Quando a página aparecer, você verá o relatório</li>
      </ul>
    </div>
    <hr />
    <div>
