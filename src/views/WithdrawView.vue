...
<template>
    ...
    <div class="container-fluid mt-3 withdrawWindows">
        ...
        <div class="channelContainer mb-4">
        ...
        <p class="text-white"> Certifique-se de que o CPF está em seu nome para evitar atrasos. </p>
        <ul class="withdrawTips">
            <li>Mín 20, máx 10000</li>
            <li>2% de taxa por saque. Em caso de saldo insuficiente, o montante creditado será deduzido </li>
        </ul>
        <!-- cpf -->
        <div class="cpf mt-2 mb-3 d-flex align-items-center mt-2 mb-3 inputBg">
            <button type="button" class="cpfSwitchBtn" data-bs-toggle="offcanvas" data-bs-target="#cpfWindow" aria-controls="cpfWindow">
        ...
        <div class="account mb-3">
            ...
            <div class="d-flex align-items-center mt-2 mb-3 inputBg">
                <button type="button" class="accountBtn" data-bs-toggle="offcanvas" data-bs-target="#accountWindow" aria-controls="accountWindow">
            ...
            <div class="content">
                ...
                <div class="slot mb-4">
                    ...
                    <li class="mb-2 d-flex align-items-center">
                        ...
                        <button type="button" class="btn p-0" data-bs-toggle="modal" data-bs-target="#BonusProdress">
                        <svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" fill="#8ea7bb" class="bi bi-question-circle-fill icon" viewBox="0 0 16 16">
                            <path d="M16 8A8 8 0 1 1 0 8a8 8 0 0 1 16 0M5.496 6.033h.825c.138 0 .248-.113.266-.25.09-.656.54-1.134 1.342-1.134.686 0 1.314.343 1.314 1.168 0 .635-.374.927-.965 1.371-.673.489-1.206 1.06-1.168 1.987l.003.217a.25.25 0 0 0 .25.246h.811a.25.25 0 0 0 .25-.25v-.105c0-.718.273-.927 1.01-1.486.609-.463 1.244-.977 1.244-2.056 0-1.511-1.276-2.241-2.673-2.241-1.267 0-2.655.59-2.75 2.286a.237.237 0 0 0 .241.247m2.325 6.443c.61 0 1.029-.394 1.029-.927 0-.552-.42-.94-1.029-.94-.584 0-1.009.388-1.009.94 0 .533.425.927 1.01.927z"></path>
                        </svg>
                        </button>
                    </li>
                    <li class="mb-2"> Para aumentar seu saldo disponível,
                        <a href="/" class="toHome">Aposte Agora</a>
                    </li>
                    </ul>
                </div>
            </div>
        ...
        <!-- 獎金優惠視窗 -->
        <div class="modal fade" id="BonusProdress" tabindex="-1" aria-labelledby="BonusProdressLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content BonusProdressModal">
                    <div class="modal-header border-0">
                    <h5 class="modal-title d-flex align-items-center" id="BonusProdressLabel">
                        <div class="modalHeaderIicon me-2">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="#b9b9b9" class="bi bi-gift" viewBox="0 0 16 16">
                    ...
                    <button type="button" class="btn p-0" data-bs-dismiss="modal" aria-label="Close">
                        <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="#98a7b5" class="bi bi-x" viewBox="0 0 16 16">
                    ...
                    <ul class="p-0">
                        ...
                        <li>Requisito de rolagem 0X</li>
                    </ul>
                    <div class="progressContent mb-2">
                        <div class="progress">
...
<style scoped>
    ...
    .withdrawWindows .channelContainer::-webkit-scrollbar{display: none;}
    ...
    .withdrawWindows .confirmBtn.active{opacity: 1;}
    /* 獎金優惠視窗 */
